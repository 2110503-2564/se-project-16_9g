...
export default function Sidebar() {
    return (
        <div className="w-[300px] mx-3 rounded-lg h-screen shadow-[0px_0px_8px_4px_rgba(0,0,0,0.15)]
        absolute top-[80px] left-0 bottom-0 p-3 text-lg text-center z-100">
            <div className="flex flex-col  ">
                ...
                hover:scale-105 duration-300" >Table Status</Link> <br />
            </div>
        </div>
    );
}