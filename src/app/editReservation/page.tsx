    ...
    return (
        <div className="flex flex-col items-center my-10 font-mono">
            <form onSubmit={handleEditReservation} className="w-[500px] p-5 flex flex-col items-center rounded-xl shadow-md">
                ...
                <div className="text-xl">{reservationData?.restaurant.name || "Loading..."}</div>
                <div className="w-[95%]">
                    ...
                    <div className="flex flex-row justify-between my-3 items-center">
                        ...
                        <div className="w-[70%]">
                            <DateReserve
                                ...
                                onDateChange={(value: Dayjs) => setResDate(value.format("YYYY-MM-DD"))}
                            />
                        </div>
                    </div>
                    <div className="flex flex-row justify-between my-3 items-center">
                        ...
                        <div className="w-[70%]">
                            <TimeReserve
                                ...
                                onTimeChange={(value: Dayjs) => setResTime(value.format("HH:mm:ss"))}
                            />
                        </div>
                    </div>
